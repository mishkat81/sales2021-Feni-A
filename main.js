...
let jan_k_sold = 00; let feb_k_sold = 0; let mar_k_sold = 0; let apr_k_sold = 0; let may_k_sold = 0; let jun_k_sold = 0; let jul_k_sold = 0; let aug_k_sold = 0; let sep_k_sold = 0; let oct_k_sold = 0; let nov_k_sold = 0; let dec_k_sold = 0;
...
let jan_i_sold = 00; let feb_i_sold = 0; let mar_i_sold = 0; let apr_i_sold = 0; let may_i_sold = 0; let jun_i_sold = 0; let jul_i_sold = 0; let aug_i_sold = 0; let sep_i_sold = 0; let oct_i_sold = 0; let nov_i_sold = 0; let dec_i_sold = 0;
...
let jan_f_sold = 0; let feb_f_sold = 0; let mar_f_sold = 0; let apr_f_sold = 0; let may_f_sold = 0; let jun_f_sold = 0; let jul_f_sold = 0; let aug_f_sold = 0; let sep_f_sold = 0; let oct_f_sold = 0; let nov_f_sold = 0; let dec_f_sold = 0;
...
let jan_s_sold = 00; let feb_s_sold = 0; let mar_s_sold = 0; let apr_s_sold = 0; let may_s_sold = 0; let jun_s_sold = 0; let jul_s_sold = 0; let aug_s_sold = 0; let sep_s_sold = 0; let oct_s_sold = 0; let nov_s_sold = 0; let dec_s_sold = 0;
...
// Total Sold Yearly Haron
let jan_h_sold = 00; let feb_h_sold = 0; let mar_h_sold = 0; let apr_h_sold = 0; let may_h_sold = 0; let jun_h_sold = 0; let jul_h_sold = 0; let aug_h_sold = 0; let sep_h_sold = 0; let oct_h_sold = 0; let nov_h_sold = 0; let dec_h_sold = 0;
...
const colleguesDetails = [
    {'name':'Kamrul Islam','t_target_y':`${kamrul_total_target}`,'t_sold_y':`${kamrul_total_sold}`,'t_achi_y':`${Math.round(kamrul_total_sold/kamrul_total_target*100).toFixed(2)}%`,'jan':`${jan_kamrul}`,'feb':`${0}`,'mar':`${0}`,'apr':`${0}`,'may':`${0}`,'jun':`${0}`,'jul':`${0}`,'aug':`${0}`,'sep':`${0}`,'oct':`${0}`,'nov':`${0}`,'dec':`${0}`},
    {'name':'Ebrahim Khalil','t_target_y':`${ibrahim_total_target}`,'t_sold_y':`${ibrahim_total_sold}`,'t_achi_y':`${Math.round(ibrahim_total_sold/ibrahim_total_target*100).toFixed(2)}%`,'jan':`${jan_ibrahim}`,'feb':`${0}`,'mar':`${0}`,'apr':`${0}`,'may':`${0}`,'jun':`${0}`,'jul':`${0}`,'aug':`${0}`,'sep':`${0}`,'oct':`${0}`,'nov':`${0}`,'dec':`${0}`},
    {'name':'Faysal Karim','t_target_y':`${faysal_total_target}`,'t_sold_y':`${faysal_total_sold}`,'t_achi_y':`${Math.round(faysal_total_sold/faysal_total_target*100).toFixed(2)}%`,'jan':`${jan_faysal}`,'feb':`${0}`,'mar':`${0}`,'apr':`${0}`,'may':`${0}`,'jun':`${0}`,'jul':`${0}`,'aug':`${0}`,'sep':`${0}`,'oct':`${0}`,'nov':`${0}`,'dec':`${0}`},
    {'name':'Sohel Rana','t_target_y':`${sohel_total_target}`,'t_sold_y':`${sohel_total_sold}`,'t_achi_y':`${Math.round(sohel_total_sold/sohel_total_target*100).toFixed(2)}%`,'jan':`${jan_sohel}`,'feb':`${0}`,'mar':`${0}`,'apr':`${0}`,'may':`${0}`,'jun':`${0}`,'jul':`${0}`,'aug':`${0}`,'sep':`${0}`,'oct':`${0}`,'nov':`${0}`,'dec':`${0}`},
    {'name':'Haron Or Rashid','t_target_y':`${Math.round(haron_total_target)}`,'t_sold_y':`${haron_total_sold}`,'t_achi_y':`${Math.round(haron_total_sold/haron_total_target*100).toFixed(2)}%`,'jan':`${jan_haron}`,'feb':`${0}`,'mar':`${0}`,'apr':`${0}`,'may':`${0}`,'jun':`${0}`,'jul':`${0}`,'aug':`${0}`,'sep':`${0}`,'oct':`${0}`,'nov':`${0}`,'dec':`${0}`},
    {'name':'Mishkat Ahmed','t_target_y':`${Math.round(mishkat_total_target)}`,'t_sold_y':`${mishkat_total_sold}`,'t_achi_y':`${Math.round(mishkat_total_sold/mishkat_total_target*100).toFixed(2)}%`,'jan':`${jan_mishkat}`,'feb':`${0}`,'mar':`${0}`,'apr':`${0}`,'may':`${0}`,'jun':`${0}`,'jul':`${0}`,'aug':`${0}`,'sep':`${0}`,'oct':`${0}`,'nov':`${0}`,'dec':`${0}`}
];
