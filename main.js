...
let jan_k_sold = 200391.89; let feb_k_sold = 202460.98; let mar_k_sold = 161106.61; let apr_k_sold = 0; let may_k_sold = 0; let jun_k_sold = 0; let jul_k_sold = 0; let aug_k_sold = 0; let sep_k_sold = 0; let oct_k_sold = 0; let nov_k_sold = 0; let dec_k_sold = 0;
...
let jan_i_sold = 296346.29; let feb_i_sold = 266316.84; let mar_i_sold = 105065.10; let apr_i_sold = 0; let may_i_sold = 0; let jun_i_sold = 0; let jul_i_sold = 0; let aug_i_sold = 0; let sep_i_sold = 0; let oct_i_sold = 0; let nov_i_sold = 0; let dec_i_sold = 0;
...
let jan_f_sold = 236278.53; let feb_f_sold = 191027.08; let mar_f_sold = 89212.28; let apr_f_sold = 0; let may_f_sold = 0; let jun_f_sold = 0; let jul_f_sold = 0; let aug_f_sold = 0; let sep_f_sold = 0; let oct_f_sold = 0; let nov_f_sold = 0; let dec_f_sold = 0;
...
let jan_s_sold = 262542.96; let feb_s_sold = 184728.53; let mar_s_sold = 76052.34; let apr_s_sold = 0; let may_s_sold = 0; let jun_s_sold = 0; let jul_s_sold = 0; let aug_s_sold = 0; let sep_s_sold = 0; let oct_s_sold = 0; let nov_s_sold = 0; let dec_s_sold = 0;
...
let jan_h_sold = 118087.34; let feb_h_sold = 103351.65; let mar_h_sold = 45161.14; let apr_h_sold = 0; let may_h_sold = 0; let jun_h_sold = 0; let jul_h_sold = 0; let aug_h_sold = 0; let sep_h_sold = 0; let oct_h_sold = 0; let nov_h_sold = 0; let dec_h_sold = 0;
...
let mar_m_sold = `${mar_k_sold+mar_i_sold+mar_f_sold+mar_s_sold+mar_h_sold}`;
...
function mTargetSoldAchi3(share, sold) {
    let target = (share * mar_n_target)/100;
    let mSold = sold;
    let mAchi = Math.round((sold / target) * 100).toFixed(2);
    return `${Math.round(target)} / ${Math.round(mSold)} / ${Math.round(mAchi)}%`;
}
...
//=========FIXED=============FOR February Target/ Sold/ Achi Area Start=================
...
//=========FIXED=============February Target/ Sold/ Achi Area Start=================

//=========FIXED=============FOR Mrch Target/ Sold/ Achi Area Start=================

//Mrch Target / Sold / Achivement
let mar_kamrul = mTargetSoldAchi3(0.08, mar_k_sold);
let mar_ibrahim = mTargetSoldAchi3(0.10, mar_i_sold);
let mar_faysal = mTargetSoldAchi3(0.08, mar_f_sold);
let mar_sohel = mTargetSoldAchi3(0.11, mar_s_sold);
let mar_haron = mTargetSoldAchi3(0.07, mar_h_sold);
let mar_mishkat = mTargetSoldAchi3(0.44, mar_m_sold);

//=========FIXED=============Mrch Target/ Sold/ Achi Area Start=================
...
const colleguesDetails = [
    {'name':'Kamrul Islam','t_target_y':`${kamrul_total_target}`,'t_sold_y':`${Math.round(kamrul_total_sold)}`,'t_achi_y':`${Math.round(kamrul_total_sold/kamrul_total_target*100).toFixed(2)}%`,'jan':`${jan_kamrul}`,'feb':`${feb_kamrul}`,'mar':`${mar_kamrul}`,'apr':`${0}`,'may':`${0}`,'jun':`${0}`,'jul':`${0}`,'aug':`${0}`,'sep':`${0}`,'oct':`${0}`,'nov':`${0}`,'dec':`${0}`},
    {'name':'Ebrahim Khalil','t_target_y':`${ibrahim_total_target}`,'t_sold_y':`${Math.round(ibrahim_total_sold)}`,'t_achi_y':`${Math.round(ibrahim_total_sold/ibrahim_total_target*100).toFixed(2)}%`,'jan':`${jan_ibrahim}`,'feb':`${feb_ibrahim}`,'mar':`${mar_ibrahim}`,'apr':`${0}`,'may':`${0}`,'jun':`${0}`,'jul':`${0}`,'aug':`${0}`,'sep':`${0}`,'oct':`${0}`,'nov':`${0}`,'dec':`${0}`},
    {'name':'Faysal Karim','t_target_y':`${faysal_total_target}`,'t_sold_y':`${Math.round(faysal_total_sold)}`,'t_achi_y':`${Math.round(faysal_total_sold/faysal_total_target*100).toFixed(2)}%`,'jan':`${jan_faysal}`,'feb':`${feb_faysal}`,'mar':`${mar_faysal}`,'apr':`${0}`,'may':`${0}`,'jun':`${0}`,'jul':`${0}`,'aug':`${0}`,'sep':`${0}`,'oct':`${0}`,'nov':`${0}`,'dec':`${0}`},
    {'name':'Sohel Rana','t_target_y':`${sohel_total_target}`,'t_sold_y':`${Math.round(sohel_total_sold)}`,'t_achi_y':`${Math.round(sohel_total_sold/sohel_total_target*100).toFixed(2)}%`,'jan':`${jan_sohel}`,'feb':`${feb_sohel}`,'mar':`${mar_sohel}`,'apr':`${0}`,'may':`${0}`,'jun':`${0}`,'jul':`${0}`,'aug':`${0}`,'sep':`${0}`,'oct':`${0}`,'nov':`${0}`,'dec':`${0}`},
    {'name':'Vacant (from 09-01-2021)','t_target_y':`${Math.round(haron_total_target)}`,'t_sold_y':`${Math.round(haron_total_sold)}`,'t_achi_y':`${Math.round(haron_total_sold/haron_total_target*100).toFixed(2)}%`,'jan':`${jan_haron}`,'feb':`${feb_haron}`,'mar':`${mar_haron}`,'apr':`${0}`,'may':`${0}`,'jun':`${0}`,'jul':`${0}`,'aug':`${0}`,'sep':`${0}`,'oct':`${0}`,'nov':`${0}`,'dec':`${0}`},
    {'name':'Mishkat Ahmed','t_target_y':`${Math.round(mishkat_total_target)}`,'t_sold_y':`${Math.round(mishkat_total_sold)}`,'t_achi_y':`${Math.round(mishkat_total_sold/mishkat_total_target*100).toFixed(2)}%`,'jan':`${jan_mishkat}`,'feb':`${feb_mishkat}`,'mar':`${mar_mishkat}`,'apr':`${0}`,'may':`${0}`,'jun':`${0}`,'jul':`${0}`,'aug':`${0}`,'sep':`${0}`,'oct':`${0}`,'nov':`${0}`,'dec':`${0}`}
];
